...
FunCoding = (function() {
    ...
    var KunciKuning = (function() {
        function KunciKuning(r, c, root, tag, takeAnimCb, useCb) {
            this.baseClass.call(this,
                new GameObject(
                    $('<image src="asset/img/kunci.png" style="top:15px;left:5px;width:40px"/>'),
                    (c * 50), (r * 50)
                ).addTo(root),
    ...
    var KunciBiru = (function() {
        function KunciBiru(r, c, root, tag, takeAnimCb, useCb) {
            this.baseClass.call(this,
                new GameObject(
                    $('<image src="asset/img/kunci2.png" style="top:15px;left:5px;width:40px"/>'),
                    (c * 50), (r * 50)
                ).addTo(root),
    ...
    var KunciMerah = (function() {
        function KunciMerah(r, c, root, tag, takeAnimCb, useCb) {
            this.baseClass.call(this,
                new GameObject(
                    $('<image src="asset/img/kunci1.png" style="top:15px;left:5px;width:40px"/>'),
                    (c * 50), (r * 50)
                ).addTo(root),
    ...
    var ExclamationMark = (function() {
        function ExclamationMark(r, c, root, takeAnimCb, useCb) {
            this.baseClass.call(this,
                new GameObject(
                    $('<image src="asset/img/point.png" style="top:20px;left:10px;width:30px"/>'),
                    (c * 50), (r * 50)
                ).addTo(root),
    ...
    var PintuKuning = (function() {
        function PintuKuning(r, c, root, takeAnimCb, useCb) {
            this.baseClass.call(this,
                new GameObject(
                    $('<img src="asset/img/pintu-kuning.png" style="height:45px;width:35px;left:7px;top:3px;">'),
                    (c * 50), (r * 50)
                ).addTo(root),
                undefined, undefined, takeAnimCb, useCb
            );
        }
        extendUtil(Item, PintuKuning);
        return PintuKuning;
    })();
    var PintuBiru = (function() {
        function PintuBiru(r, c, root, takeAnimCb, useCb) {
            this.baseClass.call(this,
                new GameObject(
                    $('<img src="asset/img/pintu-biru.png" style="height:45px;width:35px;left:7px;top:3px;">'),
                    (c * 50), (r * 50)
                ).addTo(root),
                undefined, undefined, takeAnimCb, useCb
            );
        }
        extendUtil(Item, PintuBiru);
        return PintuBiru;
    })();
    var PintuMerah = (function() {
        function PintuMerah(r, c, root, takeAnimCb, useCb) {
            this.baseClass.call(this,
                new GameObject(
                    $('<img src="asset/img/pintu-merah.png" style="height:45px;width:35px;left:7px;top:3px;">'),
                    (c * 50), (r * 50)
                ).addTo(root),
                undefined, undefined, takeAnimCb, useCb
            );
        }
        extendUtil(Item, PintuMerah);
        return PintuMerah;
    })();
    var Motor = (function() {
    ...
    var LampuMerah = (function() {
        function LampuMerah(r, c, root, total, split, start, changeCb) {
            this.r = r;
            this.c = c;
            this.redFace = $('<img src="asset/img/gerbang-merah.png" style="left:5px;width:40px;">');
            this.greenFace = $('<img src="asset/img/merah-buka.png" style="left:5px;width:40px;top:10px">').hide();
    ...
    var Player = (function() {
        ...
        Player.getNormalFace = function() {
            return [
                $('<img style="height:45px;width:25px;left:12px;top:5px;" src="asset/img/player-up.png"/>'),
                $('<img style="height:45px;width:25px;left:12px;top:5px;" src="asset/img/player-left.png"/>'),
                $('<img style="height:45px;width:25px;left:12px;top:5px;" src="asset/img/player-down.png"/>'),
                $('<img style="height:45px;width:25px;left:12px;top:5px;" src="asset/img/player-right.png"/>'),
            ];
        }
                ...
                function(finish) {
                    if (tmp[0]) {
                        ...
                        var n = new Noty({
                            ...
                            buttons: [
                                Noty.button('Ulangi', 'oh-btn-blue', function() {
                                    n.close();
                                }),
                            ]
                        }).show();
    ...
    return {
        ...
        PintuKuning: PintuKuning,
        PintuMerah: PintuMerah,
        PintuBiru: PintuBiru,
