        ...
        return items[[r, c].join()] =
            new FunCoding.ExclamationMark(r, c, root,
                function(finish) {
                    ...
                    alert('Penjaga labirin memberitahu anda untuk menggunakan kunci kuning untuk keluar dari labirin');
                    finish();
                }
            );
    })(6, 4);
        ...
        return items[[r, c].join()] = items[tag] =
            new FunCoding.KunciKuning(r, c, root, tag,
                function(finish) {
                    ...
                    alert('Kunci labirin berhasil diambil');
                    finish();
                },
                function(retVal) {
                        ...
                        if (mamaPoint.taken) {
                            ...
                            return FunCoding.sequence([
                                ...
                                function(finish) {
                                    ...
                                    alert('Tidak bisa keluar, silahkan tanya penjaga labirin dulu');
                                    finish();
                                }
                            ]);
                        }
